...
public class DaoCachorro {
	...
	public List<Cachorro> retornaListaCachorros() {
		...
		try {
			...
			while (resultadoTabelaCachorro.next()) {
				...
				cachorro.getEndereco().setCep(resultadoTabelaCachorro.getString("cep"));
				cachorro.getEndereco().setBairro(resultadoTabelaCachorro.getString("bairro"));
				cachorro.getEndereco().setLogradouro(resultadoTabelaCachorro.getString("logradouro"));
				cachorro.getEndereco().setLocalidade(resultadoTabelaCachorro.getString("localidade"));
				cachorro.getEndereco().setUf(resultadoTabelaCachorro.getString("uf"));				
	...
	public boolean alterarCachorro(Cachorro cachorro) {
		...
		String comandoSqlInsert = "UPDATE tb_cachorro SET nome = ?, corpelo = ?, preco = ?,cep = ?,localidade = ?,logradouro = ?, bairro =?, uf = ? WHERE caf = ? "; // Base do comando
																									// SQL		
		try {
			connectionBase = conexaoFabricaConexao.criarConexaoComBase(); // Recebe o objeto de
			...
			preparaOcomandoSQL.setString(3, cachorro.getPreco().toString());
			preparaOcomandoSQL.setString(4, cachorro.getEndereco().getCep());
			preparaOcomandoSQL.setString(5, cachorro.getEndereco().getLocalidade());
			preparaOcomandoSQL.setString(6, cachorro.getEndereco().getLogradouro());
			preparaOcomandoSQL.setString(7, cachorro.getEndereco().getBairro());
			preparaOcomandoSQL.setString(8, cachorro.getEndereco().getUf());
			preparaOcomandoSQL.setString(9, cachorro.getCAF());// Coloca o valor no campo cpf
